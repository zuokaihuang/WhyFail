...
<html style="width:100%;height:100%" class="no-js">
    ...
    <body style="width:100%;height:100%;margin: 0;">
    	...
    	<div id="applicationHost" class="applicationHost" style="width:100%;height:100%;" __component-context__="block"><div component="$model/UI2/system/components/justep/window/window" xid="window" design="device:mobile" data-bind="component:{name:'$model/UI2/system/components/justep/window/window'}" __cid="ceINNfi" class="ceINNfi" components="$model/UI2/system/components/justep/loadingBar/loadingBar,$model/UI2/system/components/justep/panel/panel,$model/UI2/system/components/justep/panel/child,$model/UI2/system/components/justep/model/model,$model/UI2/system/components/justep/window/window,$model/UI2/system/components/justep/titleBar/titleBar,$model/UI2/system/components/justep/data/data,$model/UI2/system/components/justep/button/button,">
  <style>.x-titlebar.ceINNfi{background-color: rgb(50, 189, 96)}</style>  
  <div component="$model/UI2/system/components/justep/model/model" xid="model" style="display:none" data-bind="component:{name:'$model/UI2/system/components/justep/model/model'}" data-events="onParamsReceive:modelParamsReceive" __cid="ceINNfi" class="ceINNfi"></div>  
  <div component="$model/UI2/system/components/justep/panel/panel" class="x-panel x-full pe8fcab58a16f415fa834eaa20a2eaba0-iosstatusbar ceINNfi" data-bind="component:{name:'$model/UI2/system/components/justep/panel/panel'}" __cid="ceINNfi"> 
    <div class="x-panel-top ceINNfi" component="$model/UI2/system/components/justep/panel/child" data-bind="component:{name:'$model/UI2/system/components/justep/panel/child'}" __cid="ceINNfi"> 
      <div component="$model/UI2/system/components/justep/titleBar/titleBar" class="x-titlebar ceINNfi" data-bind="component:{name:'$model/UI2/system/components/justep/titleBar/titleBar'}" data-config="{&#34;title&#34;:&#34;促销活动&#34;}" __cid="ceINNfi"> 
        <div class="x-titlebar-left ceINNfi" __cid="ceINNfi"> 
          <a component="$model/UI2/system/components/justep/button/button" class="btn btn-link btn-only-icon ceINNfi" xid="backBtn" data-bind="component:{name:'$model/UI2/system/components/justep/button/button'}" data-events="onClick:backBtnClick" data-config="{&#34;icon&#34;:&#34;icon-chevron-left&#34;,&#34;label&#34;:&#34;&#34;}" __cid="ceINNfi"> 
            <i class="icon-chevron-left ceINNfi" __cid="ceINNfi"></i>  
            <span __cid="ceINNfi" class="ceINNfi"></span> 
          </a> 
        </div>  
        <div class="x-titlebar-title ceINNfi" __cid="ceINNfi">促销活动</div>  
        <div class="x-titlebar-right  ceINNfi" __cid="ceINNfi">
          <div class="empty ceINNfi" __cid="ceINNfi"></div>
        </div> 
      </div> 
    </div>  
    <div class="x-panel-content ceINNfi" component="$model/UI2/system/components/justep/panel/child" data-bind="component:{name:'$model/UI2/system/components/justep/panel/child'}" __cid="ceINNfi"> 
      <div class="x-control-group ceINNfi" xid="controlGroup1" __cid="ceINNfi"> 
        <div class="x-control-group-title ceINNfi" xid="controlGroupTitle1" __cid="ceINNfi"> 
          <span xid="span1" __cid="ceINNfi" class="ceINNfi" data-bind="text:data.val('title')"></span> 
        </div>  
        <span __cid="ceINNfi" class="ceINNfi" data-bind="text:data.val('wDate')"></span>  
        <div __cid="ceINNfi" class="ceINNfi" data-bind="foreach:data.datas"> 
          <p __cid="ceINNfi" class="ceINNfi" data-bind="text:val('content')"></p> 
        </div> 
      </div> 
    </div>  
    <style __cid="ceINNfi" class="ceINNfi">.x-panel.pe8fcab58a16f415fa834eaa20a2eaba0-iosstatusbar >.x-panel-top {height: 48px;}.x-panel.pe8fcab58a16f415fa834eaa20a2eaba0-iosstatusbar >.x-panel-content { top: 48px;bottom: nullpx;}.x-panel.pe8fcab58a16f415fa834eaa20a2eaba0-iosstatusbar >.x-panel-bottom {height: nullpx;}.iosstatusbar .x-panel.pe8fcab58a16f415fa834eaa20a2eaba0-iosstatusbar >.x-panel-top,.iosstatusbar .x-panel .x-panel-content .x-has-iosstatusbar.x-panel.pe8fcab58a16f415fa834eaa20a2eaba0-iosstatusbar >.x-panel-top {height: 68px;}.iosstatusbar .x-panel.pe8fcab58a16f415fa834eaa20a2eaba0-iosstatusbar >.x-panel-content,.iosstatusbar .x-panel .x-panel-content .x-has-iosstatusbar.x-panel.pe8fcab58a16f415fa834eaa20a2eaba0-iosstatusbar >.x-panel-content { top: 68px;}.iosstatusbar .x-panel .x-panel-content .x-panel.pe8fcab58a16f415fa834eaa20a2eaba0-iosstatusbar >.x-panel-top {height: 48px;}.iosstatusbar .x-panel .x-panel-content .x-panel.pe8fcab58a16f415fa834eaa20a2eaba0-iosstatusbar >.x-panel-content {top: 48px;}</style>
  </div> 
</div></div>
        ...
        <script src="../../../v_4677_nol_zh_CNs_d_/system/core.min.js"></script><script src="../../../v_4677_nol_zh_CNs_d_/system/common.min.js"></script><script src="../../../v_4677_nol_zh_CNs_d_/system/components/comp.min.js"></script><script id="_mainScript">
			...
			if (__continueRun) {
    			...
    			requirejs.config({
    				baseUrl: window.__justep.__ResourceEngine.contextPath + '/v_4677_nol_zh_CNs_d_/LH_Team/3',
    			    paths: {
    			...
    			requirejs(['require', 'jquery', '$model/UI2/system/lib/base/composition', '$model/UI2/system/lib/base/url', '$model/UI2/system/lib/route/hashbangParser', '$model/UI2/system/components/justep/loadingBar/loadingBar', '$model/UI2/system/lib/jquery/domEvent',  '$model/UI2/system/lib/cordova/cordova'],  function (require, $, composition, URL, HashbangParser) { 
    				...
    				var context = {};
    				context.model = '$model/UI2/LH_Team/3/template.w' + (document.location.search || "");
