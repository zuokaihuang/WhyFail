...
<html style="width:100%;height:100%" class="no-js">
    ...
    <body style="width:100%;height:100%;margin: 0;">
    	...
    	<div id="applicationHost" class="applicationHost" style="width:100%;height:100%;" __component-context__="block"><div component="$model/UI2/system/components/justep/window/window" xid="window" design="device:mobile" data-bind="component:{name:'$model/UI2/system/components/justep/window/window'}" __cid="ci2AJnm" class="ci2AJnm" components="$model/UI2/system/components/justep/loadingBar/loadingBar,$model/UI2/system/components/justep/labelEdit/labelEdit,$model/UI2/system/components/justep/panel/panel,$model/UI2/system/components/justep/panel/child,$model/UI2/system/components/justep/model/model,$model/UI2/system/components/justep/window/window,$model/UI2/system/components/justep/titleBar/titleBar,$model/UI2/system/components/justep/data/data,$model/UI2/system/components/justep/button/button,$model/UI2/system/components/justep/output/output,">
  <style>.x-titlebar.ci2AJnm{background-color: rgb(50, 189, 96)}</style>  
  <div component="$model/UI2/system/components/justep/model/model" xid="model" style="display:none" data-bind="component:{name:'$model/UI2/system/components/justep/model/model'}" __cid="ci2AJnm" class="ci2AJnm"></div>  
  <div component="$model/UI2/system/components/justep/panel/panel" class="x-panel x-full p0694d6a01add4658880afd8fc8bfbed9-iosstatusbar ci2AJnm" data-bind="component:{name:'$model/UI2/system/components/justep/panel/panel'}" __cid="ci2AJnm"> 
    <div class="x-panel-top ci2AJnm" component="$model/UI2/system/components/justep/panel/child" data-bind="component:{name:'$model/UI2/system/components/justep/panel/child'}" __cid="ci2AJnm"> 
      <div component="$model/UI2/system/components/justep/titleBar/titleBar" class="x-titlebar ci2AJnm" data-bind="component:{name:'$model/UI2/system/components/justep/titleBar/titleBar'}" data-config="{&#34;title&#34;:&#34;联系我们&#34;}" __cid="ci2AJnm"> 
        <div class="x-titlebar-left ci2AJnm" __cid="ci2AJnm"> 
          <a component="$model/UI2/system/components/justep/button/button" class="btn btn-link btn-only-icon ci2AJnm" xid="backBtn" data-bind="component:{name:'$model/UI2/system/components/justep/button/button'}" data-events="onClick:backBtnClick" data-config="{&#34;icon&#34;:&#34;icon-chevron-left&#34;,&#34;label&#34;:&#34;&#34;}" __cid="ci2AJnm"> 
            <i class="icon-chevron-left ci2AJnm" __cid="ci2AJnm"></i>  
            <span __cid="ci2AJnm" class="ci2AJnm"></span> 
          </a> 
        </div>  
        <div class="x-titlebar-title ci2AJnm" __cid="ci2AJnm">联系我们</div>  
        <div class="x-titlebar-right  ci2AJnm" __cid="ci2AJnm">
          <div class="empty ci2AJnm" __cid="ci2AJnm"></div>
        </div> 
      </div> 
    </div>  
    <div class="x-panel-content panel-body ci2AJnm" component="$model/UI2/system/components/justep/panel/child" data-bind="component:{name:'$model/UI2/system/components/justep/panel/child'}" __cid="ci2AJnm"> 
      <h4 xid="h42" __cid="ci2AJnm" class="ci2AJnm" data-bind="text:data.ref('companyName')"></h4>  
      <div component="$model/UI2/system/components/justep/labelEdit/labelEdit" class="x-label-edit x-label15 ci2AJnm" xid="labelOutput1" data-bind="component:{name:'$model/UI2/system/components/justep/labelEdit/labelEdit'}" __cid="ci2AJnm"> 
        <label class="x-label ci2AJnm" xid="label1" __cid="ci2AJnm" data-bind="text:data.label('address')"></label>  
        <div component="$model/UI2/system/components/justep/output/output" class="x-output x-edit ci2AJnm" xid="output2" data-bind="component:{ref:data.ref('address'),name:'$model/UI2/system/components/justep/output/output'}" __cid="ci2AJnm"></div> 
      </div>  
      <div component="$model/UI2/system/components/justep/labelEdit/labelEdit" class="x-label-edit x-label15 ci2AJnm" xid="labelOutput2" data-bind="component:{name:'$model/UI2/system/components/justep/labelEdit/labelEdit'}" __cid="ci2AJnm"> 
        <label class="x-label ci2AJnm" xid="label2" __cid="ci2AJnm" data-bind="text:data.label('tel')"></label>  
        <div component="$model/UI2/system/components/justep/output/output" class="x-output x-edit ci2AJnm" xid="output3" data-bind="component:{ref:data.ref('tel'),name:'$model/UI2/system/components/justep/output/output'}" __cid="ci2AJnm"></div> 
      </div>  
      <div component="$model/UI2/system/components/justep/labelEdit/labelEdit" class="x-label-edit x-label15 ci2AJnm" xid="labelOutput3" data-bind="component:{name:'$model/UI2/system/components/justep/labelEdit/labelEdit'}" __cid="ci2AJnm"> 
        <label class="x-label ci2AJnm" xid="label3" __cid="ci2AJnm" data-bind="text:data.label('postalCode')"></label>  
        <div component="$model/UI2/system/components/justep/output/output" class="x-output x-edit ci2AJnm" xid="output4" data-bind="component:{ref:data.ref('postalCode'),name:'$model/UI2/system/components/justep/output/output'}" __cid="ci2AJnm"></div> 
      </div>  
      <div component="$model/UI2/system/components/justep/labelEdit/labelEdit" class="x-label-edit x-label15 ci2AJnm" xid="labelOutput4" data-bind="component:{name:'$model/UI2/system/components/justep/labelEdit/labelEdit'}" __cid="ci2AJnm"> 
        <label class="x-label ci2AJnm" xid="label4" __cid="ci2AJnm" data-bind="text:data.label('website')"></label>  
        <div component="$model/UI2/system/components/justep/output/output" class="x-output x-edit ci2AJnm" xid="output5" data-bind="component:{ref:data.ref('website'),name:'$model/UI2/system/components/justep/output/output'}" __cid="ci2AJnm"></div> 
      </div>  
      <div component="$model/UI2/system/components/justep/labelEdit/labelEdit" class="x-label-edit x-label15 ci2AJnm" xid="labelOutput5" data-bind="component:{name:'$model/UI2/system/components/justep/labelEdit/labelEdit'}" __cid="ci2AJnm"> 
        <label class="x-label ci2AJnm" xid="label5" __cid="ci2AJnm" data-bind="text:data.label('email')"></label>  
        <div component="$model/UI2/system/components/justep/output/output" class="x-output x-edit ci2AJnm" xid="output6" data-bind="component:{ref:data.ref('email'),name:'$model/UI2/system/components/justep/output/output'}" __cid="ci2AJnm"></div> 
      </div> 
    </div>  
    <style __cid="ci2AJnm" class="ci2AJnm">.x-panel.p0694d6a01add4658880afd8fc8bfbed9-iosstatusbar >.x-panel-top {height: 48px;}.x-panel.p0694d6a01add4658880afd8fc8bfbed9-iosstatusbar >.x-panel-content { top: 48px;bottom: nullpx;}.x-panel.p0694d6a01add4658880afd8fc8bfbed9-iosstatusbar >.x-panel-bottom {height: nullpx;}.iosstatusbar .x-panel.p0694d6a01add4658880afd8fc8bfbed9-iosstatusbar >.x-panel-top,.iosstatusbar .x-panel .x-panel-content .x-has-iosstatusbar.x-panel.p0694d6a01add4658880afd8fc8bfbed9-iosstatusbar >.x-panel-top {height: 68px;}.iosstatusbar .x-panel.p0694d6a01add4658880afd8fc8bfbed9-iosstatusbar >.x-panel-content,.iosstatusbar .x-panel .x-panel-content .x-has-iosstatusbar.x-panel.p0694d6a01add4658880afd8fc8bfbed9-iosstatusbar >.x-panel-content { top: 68px;}.iosstatusbar .x-panel .x-panel-content .x-panel.p0694d6a01add4658880afd8fc8bfbed9-iosstatusbar >.x-panel-top {height: 48px;}.iosstatusbar .x-panel .x-panel-content .x-panel.p0694d6a01add4658880afd8fc8bfbed9-iosstatusbar >.x-panel-content {top: 48px;}</style>
  </div> 
</div></div>
        ...
        <script src="../../../v_4677_nol_zh_CNs_d_/system/core.min.js"></script><script src="../../../v_4677_nol_zh_CNs_d_/system/common.min.js"></script><script src="../../../v_4677_nol_zh_CNs_d_/system/components/comp.min.js"></script><script id="_mainScript">
			...
			if (__continueRun) {
    			...
    			requirejs(['require', 'jquery', '$model/UI2/system/lib/base/composition', '$model/UI2/system/lib/base/url', '$model/UI2/system/lib/route/hashbangParser', '$model/UI2/system/components/justep/loadingBar/loadingBar', '$model/UI2/system/lib/jquery/domEvent',  '$model/UI2/system/lib/cordova/cordova'],  function (require, $, composition, URL, HashbangParser) { 
    				...
    				var context = {};
    				context.model = '$model/UI2/LH_Team/channel/contactUs.w' + (document.location.search || "");
