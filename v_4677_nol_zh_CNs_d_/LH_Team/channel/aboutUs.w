...
<html style="width:100%;height:100%" class="no-js">
    ...
    <body style="width:100%;height:100%;margin: 0;">
    	...
    	<div id="applicationHost" class="applicationHost" style="width:100%;height:100%;" __component-context__="block"><div component="$model/UI2/system/components/justep/window/window" xid="window" design="device:mobile" data-bind="component:{name:'$model/UI2/system/components/justep/window/window'}" __cid="cBRB7ji" class="cBRB7ji" components="$model/UI2/system/components/justep/loadingBar/loadingBar,$model/UI2/system/components/justep/panel/panel,$model/UI2/system/components/justep/panel/child,$model/UI2/system/components/justep/model/model,$model/UI2/system/components/justep/window/window,$model/UI2/system/components/justep/titleBar/titleBar,$model/UI2/system/components/justep/button/button,">
  <style>.x-titlebar.cBRB7ji{background-color: rgb(50, 189, 96)}</style>  
  <div component="$model/UI2/system/components/justep/model/model" xid="model" style="display:none" data-bind="component:{name:'$model/UI2/system/components/justep/model/model'}" __cid="cBRB7ji" class="cBRB7ji"></div>  
  <div component="$model/UI2/system/components/justep/panel/panel" class="x-panel x-full x-card p264fbae9b1dd47f9b47049c801aa9470-iosstatusbar cBRB7ji" data-bind="component:{name:'$model/UI2/system/components/justep/panel/panel'}" __cid="cBRB7ji"> 
    <div class="x-panel-top cBRB7ji" component="$model/UI2/system/components/justep/panel/child" data-bind="component:{name:'$model/UI2/system/components/justep/panel/child'}" __cid="cBRB7ji"> 
      <div component="$model/UI2/system/components/justep/titleBar/titleBar" class="x-titlebar cBRB7ji" data-bind="component:{name:'$model/UI2/system/components/justep/titleBar/titleBar'}" data-config="{&#34;title&#34;:&#34;关于我们&#34;}" __cid="cBRB7ji"> 
        <div class="x-titlebar-left cBRB7ji" __cid="cBRB7ji"> 
          <a component="$model/UI2/system/components/justep/button/button" class="btn btn-link btn-only-icon cBRB7ji" xid="backBtn" data-bind="component:{name:'$model/UI2/system/components/justep/button/button'}" data-events="onClick:backBtnClick" data-config="{&#34;icon&#34;:&#34;icon-chevron-left&#34;,&#34;label&#34;:&#34;&#34;}" __cid="cBRB7ji"> 
            <i class="icon-chevron-left cBRB7ji" __cid="cBRB7ji"></i>  
            <span __cid="cBRB7ji" class="cBRB7ji"></span> 
          </a> 
        </div>  
        <div class="x-titlebar-title cBRB7ji" __cid="cBRB7ji">关于我们</div>  
        <div class="x-titlebar-right  cBRB7ji" __cid="cBRB7ji">
          <div class="empty cBRB7ji" __cid="cBRB7ji"></div>
        </div> 
      </div> 
    </div>  
    <div class="x-panel-content x-cards panel-body cBRB7ji" component="$model/UI2/system/components/justep/panel/child" data-bind="component:{name:'$model/UI2/system/components/justep/panel/child'}" __cid="cBRB7ji"> 
      <p __cid="cBRB7ji" class="cBRB7ji">起步软件公司（Justep）成立于2006年7月。Justep先后推出了Justep X3、Justep X5企业管理与政务管理平台等系列产品，成功应用于政府、制造、航天、电力、交通和矿业等数十个领域和行业，获得广大客户的广泛认同和高度赞誉，多年来一直在用户满意度、企业用户数和合作伙伴数、产品竞争力等方面行业排名第一！起步科技坚持对客户抱以踏实认真的态度，把客户价值和成功当作最根本的目标和评判依据，致力于帮助更多的中国企业实现管理信息化的成功！</p>  
      <p __cid="cBRB7ji" class="cBRB7ji">起步软件推出的X5系列平台是集云应用、企业应用、移动应用共存的开发平台领导厂商，同时也是中国领先的管理软件联盟运营商。通过创新的技术、产品和商业模式，构建了业界的管理软件开发商联盟，推进中国信息化行业的商业模式升级，引领互联网、移动、云技术和电子商务普及时代的信息化发展方向。起步软件开创了企业应用在互联网、移动、云技术时代的全新架构和开发模式，满足了信息化建设在新技术和商业环境下的“自我掌控、随需应变、持续完善、面向未来”的需求。X5已成为管理软件和电子政务的优选平台，已被数千家开发商采用，成功应用于政府、军队、金融、制造、航天、能源、交通和建设等各个领域和行业。</p> 
    </div>  
    <style __cid="cBRB7ji" class="cBRB7ji">.x-panel.p264fbae9b1dd47f9b47049c801aa9470-iosstatusbar >.x-panel-top {height: 48px;}.x-panel.p264fbae9b1dd47f9b47049c801aa9470-iosstatusbar >.x-panel-content { top: 48px;bottom: nullpx;}.x-panel.p264fbae9b1dd47f9b47049c801aa9470-iosstatusbar >.x-panel-bottom {height: nullpx;}.iosstatusbar .x-panel.p264fbae9b1dd47f9b47049c801aa9470-iosstatusbar >.x-panel-top,.iosstatusbar .x-panel .x-panel-content .x-has-iosstatusbar.x-panel.p264fbae9b1dd47f9b47049c801aa9470-iosstatusbar >.x-panel-top {height: 68px;}.iosstatusbar .x-panel.p264fbae9b1dd47f9b47049c801aa9470-iosstatusbar >.x-panel-content,.iosstatusbar .x-panel .x-panel-content .x-has-iosstatusbar.x-panel.p264fbae9b1dd47f9b47049c801aa9470-iosstatusbar >.x-panel-content { top: 68px;}.iosstatusbar .x-panel .x-panel-content .x-panel.p264fbae9b1dd47f9b47049c801aa9470-iosstatusbar >.x-panel-top {height: 48px;}.iosstatusbar .x-panel .x-panel-content .x-panel.p264fbae9b1dd47f9b47049c801aa9470-iosstatusbar >.x-panel-content {top: 48px;}</style>
  </div> 
</div></div>
        ...
        <script src="../../../v_4677_nol_zh_CNs_d_/system/core.min.js"></script><script src="../../../v_4677_nol_zh_CNs_d_/system/common.min.js"></script><script src="../../../v_4677_nol_zh_CNs_d_/system/components/comp.min.js"></script><script id="_mainScript">
			...
			if (__continueRun) {
    			...
    			requirejs(['require', 'jquery', '$model/UI2/system/lib/base/composition', '$model/UI2/system/lib/base/url', '$model/UI2/system/lib/route/hashbangParser', '$model/UI2/system/components/justep/loadingBar/loadingBar', '$model/UI2/system/lib/jquery/domEvent',  '$model/UI2/system/lib/cordova/cordova'],  function (require, $, composition, URL, HashbangParser) { 
    				...
    				var context = {};
    				context.model = '$model/UI2/LH_Team/channel/aboutUs.w' + (document.location.search || "");
